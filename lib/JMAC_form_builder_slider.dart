...
class JMFormBuilderSlider extends StatefulWidget {
  ...
  @override
  _JMFormBuilderSliderState createState() => _JMFormBuilderSliderState();
}

class _JMFormBuilderSliderState extends State<JMFormBuilderSlider> {
                ...
                Row(
                  children: <Widget>[
                    ...
                    if (widget.displayValues != DisplayValues.none &&
                      ...
                      (widget.displayValueAsTime
                          ? Text(
                              '${getTimeStringForHours(field.value.round())}',
...
String getTimeStringForHours(mins) {
  if (mins < 60) {
    return '$mins minutes';
  } else if (mins % 60 == 0) {
